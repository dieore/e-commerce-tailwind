...
const Nav: React.FC = () => {
    ...
    return (
        <>
            <nav className="sticky grid grid-cols-12 grid-rows-1 p-5 bg-green-800">
                ...
                <div className="md:hidden col-span-10 flex items-center justify-self-end gap-6">
                    ...
                    <a className="text-white hover:underline cursor-pointer font-medium">Inicio</a>
                    <a className="text-white hover:underline cursor-pointer font-medium">Categorias</a>
                    <a className="text-white hover:underline cursor-pointer font-medium">Productos</a>
                    <a className="text-white hover:underline cursor-pointer font-medium">Destacados</a>
                    <a className="text-white hover:underline cursor-pointer font-medium">Promos</a>
                    <a className="text-white hover:underline cursor-pointer font-medium">Contacto</a>
