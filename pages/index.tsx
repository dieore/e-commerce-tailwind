...
const Home: NextPage<Props> = ({ products, categories }): JSX.Element => {
  ...
  return (
    <>
      <Slider
        images={[
          "https://http2.mlstatic.com/D_NQ_785995-MLA48811791164_012022-OO.webp",
      ...
      <div className="p-8 bg-gray-200 sm:p-0">
        <h2 className="p-4 text-gray-600 text-2xl font-light sm:pt-7">
          Más vendidos
        </h2>
...
export async function getStaticProps(): Promise<any> {
  ...
  const db = client.db();
  const incomingProducts = await db
    .collection("products")
    .find({})
    .limit(5)
    .toArray();
